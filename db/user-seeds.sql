...
INSERT INTO users (online, img, userName, password, gender, seeking, age, createdAt, updatedAt, bio) VALUES (1, 'https://media.npr.org/assets/img/2013/09/16/breakingbadformon_sq-22bf65a058ea8a79c43368f6d02ae5583eba0f13-s300-c85.jpg','WalterWhite', 'password','m','f',46,curdate(),curdate(),'This is the best dating app ever');
INSERT INTO users (online, img, userName, password, gender, seeking, age, createdAt, updatedAt, bio) VALUES (1, 'https://www.famousbirthdays.com/headshots/billy-bob-thornton-5.jpg','BillyBob', 'password','m','f',58,curdate(),curdate(),'This is the best dating app ever');
INSERT INTO users (online, img, userName, password, gender, seeking, age, createdAt, updatedAt, bio) VALUES (1, 'https://static0.therichestimages.com/wp-content/uploads/Geraldo-Rivera.jpg','GeraldoRivera', 'password','m','f',28,curdate(),curdate(),'This is the best dating app ever');
...
INSERT INTO users (online, img, userName, password, gender, seeking, age, createdAt, updatedAt, bio) VALUES (1, 'https://www.famousbirthdays.com/headshots/abby-donnelly-3.jpg','Abby', 'password','f','f',18,curdate(),curdate(),'This is the best dating app ever');
INSERT INTO users (online, img, userName, password, gender, seeking, age, createdAt, updatedAt, bio) VALUES (1, 'https://www.famousbirthdays.com/headshots/bebe-neuwirth-1.jpg','Bebe', 'password','f','f',51,curdate(),curdate(),'This is the best dating app ever');
